...
<div id="wrapper">
	...
	<div id="main">
		<div id="mainBg">
			<div id="mainPanel">
				...
				<div id="right">
					<!-- 绝对路径 -->
					<form name="loginForm" action="<%=path%>/users/login.action" method="post">
					<!-- start of login form -->
					<div id="welcome">
	...
	<div id="footer">
		<div id="text">Copyright © 2016-2017 All Rights Reserved Powered By Simoniu</div>
	</div>
</div>
</body>
</html>